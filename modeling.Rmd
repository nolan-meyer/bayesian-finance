...
The predictions for the second model seem to be slightly better as more posterior predictive points are nearer to the actual values of earnings in "2020".
...
After combining the two datasets, we then evaluate the accuracy rate for the Bayesian forecast model:
