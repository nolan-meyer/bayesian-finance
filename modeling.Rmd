...
In our model notation below, $Y$ is earnings for the next year and $X$ is earnings in the current year. Both variables are independent. For example, Y = Earnings of Apple in 2017 in billions, and X = Earnings of Apple in 2016 in billions. 
...
### Interpreting Coefficents: NOT COMPLETED
