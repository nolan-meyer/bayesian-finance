...
Again, several company earnings's on the right seem to be causing model fitness difficulties. Both models run into this problem. 
...
**Model 3 - Specific Examples with companies:**
...
We can see that our model 3 preforms slightly better. Where our average median posterior prediction is off by .3697147 billion as opposed to model 2's .40 billion. Furthermore, our 95% and 50% interval values are both slightly better than model 2's. 
