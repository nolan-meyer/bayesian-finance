...
```{r, eval=FALSE}
xfun::embed_files(c('data.Rmd', 'modeling.Rmd', 'finalmodel.Rmd', 'FINALDATASET.csv', 'RandomCompnay.csv', 'bayesian_forecast_earnigns.csv', 'Diff_Inter_train_nick.rds', 'Diff_inter_slope_train_nick.rds'))
```